...
$("#fullscreen-button").on("click", function () {
  ...
  async function fetchMarketCap() {
    const tokenAddress = "E6r5oPCnd2ezVsX2MS4N1UfUNcZCkdFZCHFR8frspump"; // Replace with your token address
  ...
  function createInfoDisplay() {
    ...
    const fullAddress = "E6r5oPCnd2ezVsX2MS4N1UfUNcZCkdFZCHFR8frspump";
